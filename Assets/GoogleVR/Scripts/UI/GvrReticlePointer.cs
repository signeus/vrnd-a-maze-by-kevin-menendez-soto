...
public class GvrReticlePointer : GvrBasePointer {
  ...
  public float reticleDistanceMax = 10.0f;
  ...
  public override float MaxPointerDistance { get { return reticleDistanceMax; } }
  ...
  public void UpdateDiameters() {
    ReticleDistanceInMeters =
      Mathf.Clamp(ReticleDistanceInMeters, RETICLE_DISTANCE_MIN, reticleDistanceMax);
  ...
  private bool SetPointerTarget(Vector3 target, bool interactive) {
    ...
    ReticleDistanceInMeters =
      Mathf.Clamp(targetLocalPosition.z, RETICLE_DISTANCE_MIN, reticleDistanceMax);
    if (interactive) {
